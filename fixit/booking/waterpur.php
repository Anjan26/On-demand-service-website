...
<html lang="en">
    ...
    <body>
          ...
          <div class="container" style="position: relative;margin-top: 120px; ">
            <div class="row">
              <div class="col-sm-12 col-md-7"  >
                <h1 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: white; text-shadow:3px 3px 7px black; margin:auto; text-align:center"><b>Water Purifier Service & Repair in your city</b></h1>
              </br>
                <ul class="list">
                    <li><h4><b>Spares at 50% lower price than market</b></h4></li></br>
                    <li><h4><b>Best in Class Products: All products are certified and tested</b></h4></li></br>
                    <li><h4><b>45 day service guarantee</b></h4></li></br>
        ...
        $date = $_POST['date'];
        $wpurservice = "Water Purifier Service"; 
        $sql = "update details set booking_date='$date', services='$wpurservice' where email='$email'";
