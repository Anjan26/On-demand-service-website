...
<html lang="en">
    ...
    <body>
          ...
          <div class="container" style="position: relative; margin-top: 120px;">
            <div class="row">
              <div class="col-sm-12 col-md-7"  >
                <h1 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: white; text-shadow:3px 3px 7px black; margin:auto; text-align:center"><b>Bathroom Cleaning Service in your city</b></h1>
              </br>
                <ul class="list">
                    
                    <li><h4><b>Deposit removal & taps and fittings</b></h4></li></br>
                    <li><h4><b>Stain removal from floor, tiles & marbles</b></h4></li></br>
                    <li><h4><b>Deep cleaning of WC, wash basin, mirror, geyser & exhaust fan</b></h4></li></br>
              ...
              <div class="box">
                ...
                <input type="checkbox" name="mark" value="submit" required style="margin-left:0%"> <b style="color: #8D99AE; font-size:1em; margin-left:-18%;padding-right:30px">Accept Terms & Conditions</b>                </br>
        ...
        $date = $_POST['date'];
        $b_roomservice = "Bathroom Cleaning Service"; 
        $sql = "update details set booking_date='$date', services='$b_roomservice' where email='$email'";
