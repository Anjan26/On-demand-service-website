...
<html lang="en">
    ...
    <body>
          ...
          <div class="container" style="position: relative; margin-top: 120px;">
            <div class="row">
              <div class="col-sm-12 col-md-7"  >
                <h1 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: white; text-shadow:3px 3px 7px black; margin:auto; text-align:center"><b>Painting Service in your city</b></h1>
              </br>
                <ul class="list">
                    
                    <li><h4><b>Top Quality Paints & Transparent Costs</b></h4></li></br>
                    <li><h4><b>2 Year Service guarantee</b></h4></li></br>
                    <li><h4><b>On-Time & Mess-Free Experience</b></h4></li></br>
        ...
        $date = $_POST['date'];
        $paintservice = "Painting Service"; 
        $sql = "update details set booking_date='$date', services='$paintservice' where email='$email'";
