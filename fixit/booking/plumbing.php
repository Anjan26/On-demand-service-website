...
<html lang="en">
    ...
    <body>
          ...
          <div class="container" style="position: relative; margin-top: 120px; ">
            <div class="row">
              <div class="col-sm-12 col-md-7"  >
                <h1 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: black; text-shadow:3px 3px 7px black; margin:auto; text-align:center"><b>Plumbing Service in your city</b></h1>
              </br>
                <ul class="list">
                    <li><h4><b>Expert Technicians</b></h4></li></br>
                    <li><h4><b>Doorstep repair within 45 mins</b></h4></li></br>
                    <li><h4><b>Protection Against Damage Upto 10,000</b></h4></li></br>
                    <li><h4><b>30 day post-repair guarantee</b></h4></li></br>
        ...
        $date = $_POST['date'];
        $plumbservice = "Plumbing Service"; 
        $sql = "update details set booking_date='$date', services='$plumbservice' where email='$email'";
