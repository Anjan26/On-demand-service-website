...
<html lang="en">
    ...
    <body>
          ...
          <div class="container" style="position: relative; margin-top: 120px; ">
            <div class="row">
              <div class="col-sm-12 col-md-7"  >
                <h1 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: white; text-shadow:3px 3px 7px black; margin:auto; text-align:center"><b>AC Service & Repairs in your city</b></h1>
              </br>
                <ul class="list">
                    <li><h4><b>Power jet AC Service for better cooling</b></h4></li></br>
                    <li><h4><b>90 days repair warranty</b></h4></li></br>
                    <li><h4><b>Background checked and trained technicians with genuine parts & fixed pricing</b></h4></li></br>
        ...
        $sql = "update details set booking_date='$date', services='$acservice' where email='$email'";
