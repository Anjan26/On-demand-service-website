...
<html lang="en">
    ...
    <body>
          ...
          <div class="container" style="position: relative; margin-top: 120px;">
            <div class="row">
              <div class="col-sm-12 col-md-7"  >
                <h1 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: white; text-shadow:3px 3px 7px black; margin:auto; text-align:center"><b>Washing Machine Service & Repair in your city</b></h1>
              </br>
                <ul class="list">
                    <li><h4><b>Doorstep repair within 90 mins</b></h4></li></br>
                    <li><h4><b>Protection Against Damage Upto 10,000</b></h4></li></br>
                    <li><h4><b>15 day post-service guarantee</b></h4></li></br>
        ...
        $date = $_POST['date'];
        $wmservice = "Washing Machine Service"; 
        $sql = "update details set booking_date='$date', services='$wmservice' where email='$email'";
