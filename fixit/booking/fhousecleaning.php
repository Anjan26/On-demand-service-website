...
<html lang="en">
    ...
    <title>Full House Cleaning</title>
    ...
    <body>
          ...
          <div class="container" style="position: relative; margin-top: 120px;">
            <div class="row">
              <div class="col-sm-12 col-md-7"  >
                <h1 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: white; text-shadow:3px 3px 7px black; margin:auto; text-align:center"><b>Full House Cleaning Service in your city</b></h1>
              </br>
                <ul class="list">
                    
                    <li><h4><b>Stain removal from floor, tiles & marbles</b></h4></li></br>
                    <li><h4><b>Sanitize fully</b></h4></li></br>
                    <li><h4><b>Reach out & cover every corners</b></h4></li></br>
        ...
        $date = $_POST['date'];
        $houseservice = "Full House Cleaning Service"; 
        $sql = "update details set booking_date='$date', services='$houseservice' where email='$email'";
