...
<html lang="en">
    ...
    <body>
          ...
          <div class="container" style="position: relative; margin-top: 120px; ">
            <div class="row">
              <div class="col-sm-12 col-md-7"  >
                <h1 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: white; text-shadow:3px 3px 7px black; margin:auto; text-align:center"><b>Geyser Service & Repair in your city</b></h1>
              </br>
                <ul class="list">
        ...
        if(isset($_POST['submit'])){
          ...
          $date = $_POST['date'];
        $geyserservice = "Geyser Service"; 
        $sql = "update details set booking_date='$date', services='$geyserservice' where email='$email'";
