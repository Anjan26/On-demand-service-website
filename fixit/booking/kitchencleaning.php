...
<html lang="en">
    ...
    <body>
          ...
          <div class="container" style="position: relative; margin-top: 120px;">
            <div class="row">
              <div class="col-sm-12 col-md-7"  >
                <h1 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: white; text-shadow:3px 3px 7px black; margin:auto; text-align:center"><b>Kitchen Cleaning Service in your city</b></h1>
              </br>
                <ul class="list">
                    
                    <li><h4><b>Stain removal from floor, tiles & marbles</b></h4></li></br>
                    <li><h4><b>Mechanized equipment & Professional  Cleaning solutions</b></h4></li></br>
                    <li><h4><b>Trained & Background-Verified Professionals</b></h4></li></br>
        ...
        if(isset($_POST['submit'])){
          ...
          $date = $_POST['date'];
        $kit_service = "Kitchen Cleaning Service"; 
        $sql = "update details set booking_date='$date', services='$kit_service' where email='$email'";
