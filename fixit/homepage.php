   ...
   <div id="box2">
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner" style="width: 28%; margin-left: 37%; position: relative;z-index: 1000;">
        ...
        <a href="./feedback/feedbackhome.php"><img src="images/fed3.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="images/fed5.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner" style="width: 28%; margin-left: -5%;margin-top: -14.7%;position: relative;z-index: 1000;">
        <div class="carousel-item active">
        <a href="./feedback/feedbackhome.php"><img src="images/fed5.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="images/fed3.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
