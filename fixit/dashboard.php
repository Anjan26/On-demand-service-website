...
while ($row = $account_view->fetch_assoc()){
  ...
  $serdate=$row['booking_date'];
   echo"<tr>";
    echo "<td style='border: 1px solid white;'>"."First Name &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$fn."</td>";
   echo"</tr>";
   echo"<tr>"; 
    echo "<td style='border: 1px solid white;'>"."Last Name&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$ln."</td>";
   echo"</tr>";
   echo"<tr>";
    echo "<td style='border: 1px solid white;'>"."Phone No. &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$ph."</td>";
   echo"</tr>";
   echo"<tr>";
    echo "<td style='border: 1px solid white;'>"."Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$em."</td>";
   echo"</tr>";
   echo"<tr>";
    echo "<td style='border: 1px solid white;'>"."Password &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$pwd."</td>";
   echo"</tr>"; 
   echo"<tr>";
    echo "<td style='border: 1px solid white;'>"."Address &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$add."</td>";
   echo"</tr>"; 
   echo"<tr>";
    echo "<td style='border: 1px solid white;'>"."Date of Birth&nbsp&nbsp&nbsp&nbsp".$DOB."</td>";
   echo"</tr>";
   echo"<tr>";
   echo "<td style='border: 1px solid white;'>"."Service&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$ser."</td>";
  echo"</tr>";
  echo"<tr>";
  echo "<td style='border: 1px solid white;'>"."Booking Date&nbsp&nbsp&nbsp".$serdate."</td>";
 echo"</tr>";
}
echo "</table>";
...
?>
      ...
      <div id="box6">
        ...
        <div style="color: white; position: relative;margin-top: -7%;">
          ...
          <a href="https://www.instagram.com/"><img src="images/insta.png" style="width: 2%;margin-left: 80%;position: relative; margin-top: -50px;"></a>
